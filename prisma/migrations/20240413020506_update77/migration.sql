...
INSERT INTO "new_Review" ("author", "bookListId", "createdAt", "description", "genre", "id", "title", "updatedAt") SELECT "author", "bookListId", "createdAt", "description", "genre", "id", "title", "updatedAt" FROM "Review";
DROP TABLE "Review";
